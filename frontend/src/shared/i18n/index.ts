  ...
  "zh-CN": {
    translation: {
      ...
      settings: {
        ...
        globalProxy: { title: "全局出口代理", enabled: "启用全局代理", enabledHelp: "启用后普通 Build、Web 和 Console 出站连接强制使用此代理，并覆盖账号出口节点；图片和视频的创建、轮询、上传及下载始终直连。", scheme: "代理协议", host: "代理主机", port: "代理端口", username: "用户名（可选）", password: "密码（可选）", keepPassword: "留空保持当前已保存密码；清空用户名可移除认证。" },
...
Object.assign(resources.en.translation.settings as unknown as Record<string, unknown>, {
  globalProxy: {
    title: "Global outbound proxy",
    enabled: "Enable global proxy",
    enabledHelp: "Route ordinary Build, Web, and Console outbound connections through this proxy and override account-level egress nodes. Image and video creation, polling, upload, and download always connect directly.",
    scheme: "Proxy protocol",
    host: "Proxy host",
    port: "Proxy port",
    username: "Username (optional)",
    password: "Password (optional)",
    keepPassword: "Leave blank to keep the saved password; clear the username to remove authentication.",
  },
});
